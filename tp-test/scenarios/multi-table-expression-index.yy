...
key_c_str: [weight=2] key_c_str_part | , unique key(c_str) | , unique key(c_str(prefix_idx_len)) { T.mark_id('c_str') }
...
expression_index:
    , key((c_int + 1)), key((c_int -1)), key((lower(c_str))), key((md5(c_str))), key((reverse(c_str))), key((upper(c_str)))
...
predicate1:
 ...
 |  t1.c_int + 1 rand_cmp t2.c_int + 1
 |  t1.c_int - 1 rand_cmp t2.c_int - 1
 |  1 - t1.c_int rand_cmp 1 - t2.c_int
 |  t1.c_int - t1.c_decimal rand_cmp t2.c_int - t2.c_decimal
 |  t1.c_int + t1.c_decimal rand_cmp t2.c_int + t2.c_decimal
 |  reverse(t1.c_str) rand_cmp reverse(t2.c_str)
 |  lower(t1.c_str) rand_cmp lower(t2.c_str)
 |  upper(t1.c_str) rand_cmp upper(t2.c_str)
 |  md5(t1.c_str) rand_cmp md5(t2.c_str)
...
predicate2:
 ...
 |  { printf("t%d.c_int + 1", math.random(2)) } = rand_c_int_t1 + 1
 |  { printf("t%d.c_int - 1", math.random(2)) } = rand_c_int_t1 - 1
 |  { printf("t%d.c_int + 1", math.random(2)) } in (rand_c_int_t1 + 1, rand_c_int_t2 + 1, rand_c_int_t1 + 1)
 |  { printf("t%d.c_int - 1", math.random(2)) } in (rand_c_int_t1 - 1, rand_c_int_t2 - 1, rand_c_int_t1 - 1)
 |  { printf("reverse(t%d.c_str)", math.random(2)) } = reverse(rand_c_str)
 |  { printf("lower(t%d.c_str)", math.random(2)) } = lower(rand_c_str)
 |  { printf("upper(t%d.c_str)", math.random(2)) } = upper(rand_c_str)
 |  { printf("md5(t%d.c_str)", math.random(2)) } = md5(rand_c_str)
 |  { printf("reverse(t%d.c_str)", math.random(2)) } in (reverse(rand_c_str), reverse(rand_c_str), reverse(rand_c_str))
 |  { printf("lower(t%d.c_str)", math.random(2)) } in (lower(rand_c_str), lower(rand_c_str), lower(rand_c_str))
 |  { printf("upper(t%d.c_str)", math.random(2)) } in (upper(rand_c_str), upper(rand_c_str), upper(rand_c_str))
 |  { printf("md5(t%d.c_str)", math.random(2)) } in (md5(rand_c_str), md5(rand_c_str), reverse(rand_c_str))
